...
class AssistedInstallerAPIClient:
    ...
    def __init__(self, base_url: str = "https://api.openshift.com", auth_token: Optional[str] = None):
        """
    ...
    def get_logs_download_url(self, cluster_id: str) -> Dict[str, Any]:
        ...
        logger.info(f"Fetching presigned URL for cluster {cluster_id}")
    ...
    def download_logs(self, cluster_id: str) -> nestedarchive.RemoteNestedArchive:
        ...
        logger.info(f"Downloading logs from {logs_url}")
